...
import { Info, ListTodo, FileText, Target, Plus, Check, Save, Clock } from 'lucide-react';
...
export default function EditVisitDialog({ isOpen, onClose, visit, clients, onSave }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        onSave && onSave(await response.json());
      }
    } catch (error) {
